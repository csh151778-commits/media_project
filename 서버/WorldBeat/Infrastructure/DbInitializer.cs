    ...
    public sealed class DbInitializer
    {
        ...
        public async Task InitializeAsync(CancellationToken cancellationToken = default)
        {
            ...
            cmd.CommandText = @"
                ...
                CREATE INDEX IF NOT EXISTS IX_Songs_LastPlayedAt ON Songs(LastPlayedAt DESC);
            ...
            if (!await HasColumnAsync(conn, "Songs", "LastPlayedAt", cancellationToken))
            {
                ...
                var addIndex = conn.CreateCommand();
                addIndex.CommandText = "CREATE INDEX IF NOT EXISTS IX_Songs_LastPlayedAt ON Songs(LastPlayedAt DESC);";
